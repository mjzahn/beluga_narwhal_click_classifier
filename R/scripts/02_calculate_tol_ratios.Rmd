...
avgSpec_band_diff <- function(Acoustic_Study, evNum, clipping_level, filterfrom_khz) {
  ...
  ## sum
  TOL_16to25_sum_dB <- 10*log10(band_16kHz_sum_dB / band_25kHz_sum_dB)
  TOL_25to40_sum_dB <- 10*log10(band_25kHz_sum_dB / band_40kHz_sum_dB)
