...
kong_narwhal <- Kong_dets_20kHzPP %>% filter(species=='X085')
...
# save file
save(kong_dets_0kHzPP_filter, file=here('R/Rdata/1hr/Kong_20kHzPG_20kHzPP_1hr_wavTime_filtered_labeled.rdata'))
