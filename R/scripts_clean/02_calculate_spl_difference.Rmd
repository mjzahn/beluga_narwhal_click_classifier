...
avSpec_all <- calculateAverageSpectra(kong_dets_0kHzPP_filter,wl=512,evNum="4094",
...
avgSpec_band_diff <- function(Acoustic_Study, evNum, clipping_level, filterfrom_khz) {
  ...
  df_SPL_diff <- data.frame(eventId=evNum,
                            species=species_id,
                            spl_diff_16to25_TOL_mean_dB=spl_diff_16to25_TOL_mean_dB, 
                            spl_diff_25to40_TOL_mean_dB=spl_diff_25to40_TOL_mean_dB,
                            spl_diff_16to25_TOL_sum_dB=spl_diff_16to25_TOL_sum_dB, 
                            spl_diff_25to40_TOL_sum_dB=spl_diff_25to40_TOL_sum_dB,
                            n_dets=n_clicks)
...
calculate_SPL_diff <- function(Acoustic_Study, clipping_level, filterfrom_khz) {
  ...
  band_diff_df <- data.frame(eventId=c(),species=c(),
                             spl_diff_16to25_TOL_mean_dB=c(),spl_diff_25to40_TOL_mean_dB=c(),
                             spl_diff_16to25_TOL_sum_dB=c(),spl_diff_25to40_TOL_sum_dB=c(),
                             n_dets=c())
