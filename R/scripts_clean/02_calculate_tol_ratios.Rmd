...
avgSpec_band_diff <- function(Acoustic_Study, evNum, clipping_level, filterfrom_khz) {
  ...
  ## calculate difference between freq bands
  ## mean
  TOL_16to25_mean_dB <- band_25kHz_mean_dB - band_16kHz_mean_dB
  TOL_25to40_mean_dB <- band_40kHz_mean_dB - band_25kHz_mean_dB
  
  ## sum
  TOL_16to25_sum_dB <- band_25kHz_sum_dB - band_16kHz_sum_dB
  TOL_25to40_sum_dB <- band_40kHz_sum_dB - band_25kHz_sum_dB
