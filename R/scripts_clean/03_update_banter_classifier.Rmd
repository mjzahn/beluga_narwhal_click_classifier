...
```{r rerun Banter training model - Only Det 2 and 3 - no spl vars}
## export banter model
load(here("R/Rdata/Monodontid_2013_data_ch1.rdata"))
...
summary(bant.mdl_spl)

## get RF data from banter model
event.rf <- getBanterModel(bant.mdl_spl, "event")

## OTHER THINGS TO LOOK INTO: -------------------------------
## get RF data for specific detector - example of Det 5:
(event.rf.Det4 <- getBanterModel(bant.mdl_spl, "Click_Detector_4"))
...
## run Event model------------------------------------------------------------
bant.mdl_spl <- runBanterModel(bant.mdl, ntree = 10000, sampsize = 9)
...
## get predictor names for event level RF model
colnames(bant.mdl_spl@model.data)

## save model
save(bant.mdl_spl, file=here("R/Rdata/train_bant_mdl_spl.Rdata"))
...
## run Event model------------------------------------------------------------
bant.mdl_spl_tol <- runBanterModel(bant.mdl, ntree = 10000, sampsize = 9)

## look at summary for Event model
summary(bant.mdl_spl_tol)
...
## save model
save(bant.mdl_spl_tol, file=here("R/Rdata/train_bant_mdl_spl_tol.Rdata"))
